...
export const pedAPatients: Patient[] = [
  ...
  },
  {
    ...
    pelodScore: 24,
    adherence: 72,
    diagnosis: "État de mal épileptique réfractaire",
  ...
  },
  {
    ...
    pelodScore: 10,
    adherence: 90,
    diagnosis: "Transposition des gros vaisseaux - Post chirurgie cardiaque",
    exam: "ECHO",
    priority: "Faible",
    tour: "Départ",
    brainScore: 0,
  ...
  },
  {
    ...
    pelodScore: 8,
    adherence: 72,
    diagnosis: "Hernie diaphragmatique congénitale",
    exam: "Scan thoracique",
    priority: "Faible",
    brainScore: 0,
    heartScore: 0,
    lungsScore: 2,
